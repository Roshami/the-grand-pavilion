          ...
          <div className="fixed inset-y-0 left-0 w-64 bg-emerald-800 shadow-xl">
            <div className="flex h-full flex-col pt-5 pb-4">
              <div className="flex items-center px-4">
                ...
                <span className="text-xl font-serif font-bold text-white ml-2">
                  Staff
                </span>
              </div>
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              <li>
                <ul role="list" className="-mx-2 space-y-1">
                  ...
                  <hr className="border-emerald-600 my-2" />
                  {/* ✅ NEW: Back to Home link at top */}
                  <Link
                    to="/"
                    className="group flex items-center px-2 py-3 text-sm text-cream-100 text-emerald-100 hover:bg-emerald-700 hover:text-white gap-x-3 p-2 leading-6 font-semibold rounded-md mb-2"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className={`mt-4 ${sidebarOpen ? '' : 'hidden'}`}>
                  <div className="flex items-center gap-x-4 px-2 py-3 bg-emerald-700 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-emerald-200 capitalize truncate">
                        Staff Member
                      </p>
                    </div>
                  </div>
